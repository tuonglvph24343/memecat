...
happyButton.addEventListener("click", function() {
  if (isHappy) {
    catImage.src = "./images/HappyCat.gif";
    if (isSoundPlaying) {
      catSound.pause();
    ...
    catImage.src = "./images/HappyCatd.gif";
    if (!isSoundPlaying) {
...
susButton.addEventListener("click", function() {
  if (!isSUSPlaying) {
    ...
    theRockSound.play();
    isSUSPlaying = true;
    theRockCatImage.src = "./images/TheRockCat.gif";
    setTimeout(function() {
      theRockCatImage.src = "./images/TheRockCatPic.png";
...
cryButton.addEventListener("click", function() {
  if (isCrying) {
    cryingCatImage.src = "./images/CryingCatRun.gif";
    ...
    cryingCatImage.src = "./images/CryingCat.gif";
    if (!isCryingSoundPlaying) {
